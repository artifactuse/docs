...
<Update label="v0.1.27" description="Inline Code Preview & Smart Diff">
...
provideArtifactuse({
  inlinePreview: {
    maxLines: 15,                                    // Lines before truncation
...
- Added [Inline Code Preview](/components/agent-message#inline-code-preview) config documentation

...
npm install @codemirror/state @codemirror/view @codemirror/commands \
  ...
  @codemirror/lang-javascript @codemirror/lang-python @lezer/highlight
```
...
<Note>
Without the `editor` config, the edit tab button won't appear — the feature degrades gracefully. Language modules (`langJavascript`, `langPython`) and `lezerHighlight` are optional but recommended for syntax highlighting.
</Note>